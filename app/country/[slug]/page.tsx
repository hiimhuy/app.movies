...
const CountryPage = () => {
  ...
  const { data, loading, error, fetchDataCountryMovies, page, setPage, setPrevPage, setNextPage, setSlug } = useCounterStore((state) => ({
    data: state.data?.data,
    loading: state.loading,
    error: state.error,
    fetchDataCountryMovies: state.fetchDataCountryMovies,
    page: state.page,

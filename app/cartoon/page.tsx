...
const CartoonPage = () => {
  ...
  const { data, loading, error, fetchDataCartoonMovies, page, setPage, setPrevPage, setNextPage } = useCounterStore((state) => ({
    data: state.data?.data,
    loading: state.loading,
    error: state.error,
    fetchDataCartoonMovies: state.fetchDataCartoonMovies,
    page: state.page,
